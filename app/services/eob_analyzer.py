        ...
        for item in claim.line_items:
            ...
            if key in service_descriptions:
                ...
                opportunities.append(schemas.SavingsOpportunity(
                    ...
                    description=f"Potential duplicate charge: {item.service_description}",
    ...
    for claim in claims:
        if not claim.in_network and claim.total_patient_responsibility > 0:
            ...
            opportunities.append(schemas.SavingsOpportunity(
                ...
                description=f"Out-of-network balance billing detected at {claim.facility_name}",
            ...
            for item in denied_items:
                if item.billed_amount > 100:  # Only flag significant amounts
                    ...
                    opportunities.append(schemas.SavingsOpportunity(
                        ...
                        description=f"Denied claim for {item.service_description} - may be appealable",
